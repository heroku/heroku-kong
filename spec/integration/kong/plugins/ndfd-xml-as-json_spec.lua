...
describe("ndfd-xml-as-json plugin", function()
  setup(function()
    ...
    spec_helper.insert_fixtures {
      api = {
        {name = "ndfd-api", request_path = "/ndfd", upstream_url = "http://mockbin.com/bin/dabf0b5d-bdd3-4389-be94-c4eb5f59a8d7"}
      },
      plugin = {
        {name = "ndfd-xml-as-json", __api = 1},
      }
    }
  ...
  describe("API responses", function()
    local BASE_URL = spec_helper.PROXY_URL.."/ndfd"
